const profile = () => {
    ...
    <div className=" bg-slate-50 h-10/12 w-11/12 m-8 p-4 ">
        ...
        <div className="flex justify-between"><div class="mb-4 w-full">
            <label for="firstName" class="block text-sm font-medium text-gray-700 text-left  ">First Name:</label>
            <input type="text" id="firstName" name="firstName" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md w-9/12"/>
        </div>

        <div class="mb-4 w-full">
            <label for="lastName" class="block text-sm font-medium text-gray-700 text-left">Last Name:</label>
            <input type="text" id="lastName" name="lastName" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md w-9/12" />
        </div></div>
        ...
        <div class="mb-4">
            <label for="location" class="block text-sm font-medium text-gray-700 text-left">Location:</label>
        ...
        <div class="mb-4">
            <label for="confirmPassword" class="block text-sm font-medium text-gray-700 text-left">Confirm Password:</label>
